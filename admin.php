...
<section class="container">
    <div class="login">
      <h1>Öğrenci ödev yükleme portalı</h1>
      <form method="post" action="check.php">
        <p><input type="text" name="username" value="" placeholder="Kullanıcı Adı"></p>
        <p><input type="password" name="password" value="" placeholder="Parola"></p>
        
        <p class="submit"><input type="submit" name="commit" value="Giriş"></p>
      </form>
    </div>
</center>
</body>
